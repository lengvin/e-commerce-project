...
Класс, наследующийся от абстрактного класса BaseProduct и класса MixinLog, для создания объекта продукта, который хранит в себе информацию о продукте, пример использования:
```
